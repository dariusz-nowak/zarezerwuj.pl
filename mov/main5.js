...
$('document').ready(function() {
  if (!getCookie('privacyAndCookiePolicy')) {
    $('#privacyAndCookiePolicy').fadeIn();
  }

  $('.cPolicyClose').click(function() {
    setCookie('privacyAndCookiePolicy', true, 30);
    $('#privacyAndCookiePolicy').fadeOut();
  });
});